 ...
 * @author Anura
 */
public class Update_event_val extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            String food_avl=request.getParameter("food_avl");
            ...
            if(db.update_event(id, event_name, food_avl, event_place, desc, date, time))
                out.print("<script>alert('Event updated successfully!');window.location='index.jsp';</script>");
            else
